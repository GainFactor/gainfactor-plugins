...
1. 使用当前宿主的文件枚举能力 扫描 Guardrails、ADR、架构说明、CI 规则、事故复盘、Runbook、发布规范
...
5. 宿主交互提问机制只问关键缺口：触发原因、范围边界、影响域、阻塞级别、是否已有现成规范、事实与文档冲突时哪个更接近目标状态
