...
|------|------|------|------|
| Lint | `python3 <gainfactor-pm-plugin-root>/scripts/trace_lint.py --format json {strategy_path}` | PASS/FAIL | {critical issue/none} |
| RTM aggregation | `python3 <gainfactor-pm-plugin-root>/scripts/trace_build_rtm.py --format json {prd_path} {strategy_path}` | PASS / FAIL | {critical issue / none} |
