...
- [ ] 是否先执行了 `python3 <gainfactor-pm-plugin-root>/scripts/trace_lint.py --format json <Test Strategy 路径>`？
- [ ] 是否先执行了 `python3 <gainfactor-pm-plugin-root>/scripts/trace_build_rtm.py --format json <PRD 路径> <Test Strategy 路径>`？
