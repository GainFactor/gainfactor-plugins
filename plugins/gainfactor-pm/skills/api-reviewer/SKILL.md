...
□ Phase 0：基线收集与确认
  ...
  □ 0.2 使用当前宿主的文件枚举能力 扫描 PRD/边界确认/既有 Contract
  □ 0.3 宿主交互提问机制确认 PRD 基线与契约类型
...
2. 使用当前宿主的文件枚举能力 扫描 PRD/边界确认/既有 Contract/现有 Guardrails
3. 宿主交互提问机制确认 PRD 基线、契约类型、是否多协议（模板见 `references/askuser-templates.md`）
